...
sections = {
    2: ['log','info','warn','error','verbose','print_confirm_banner','trim_whitespace','format_timestamp','step_header','show_logo','show_brand_line','fn_quit','read_local_conf_var','is_private_url','resolve_effective_dl_dir','resolve_effective_sstate_dir','derive_bitbake_git_mirror_path','detect_harness_root','detect_wsl','calc_parallelism','probe_npm_registry','resolve_npm_registry','read_kv_field','read_manifest_field','select_from_list','confirm_action','prompt_for_absolute_path','require_path'],
    3: ['read_source_label','is_valid_repo_url','normalize_repo_url','derive_source_label','write_source_manifest','ensure_bootstrap_local_conf','verify_source','select_openbmc_repo_url','list_available_machines','print_available_machines','require_openbmc_repo','print_previously_initialized','resolve_machine'],

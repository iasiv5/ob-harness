...
5. Read `rules/05_KNOWHOW_INDEX.md` — understand available know-how
...
**Know-how** 是 AI 可复用的实操经验，包括工作流和最佳实践。

**重要：遇到"怎么做 X"时，先查 know-how 再查系统工具。** 搜索顺序：(1) `rules/05_KNOWHOW_INDEX.md` → (2) 系统工具。

**想添加新能力** → 参考 `rules/knowhow/bestpractice_01-knowhow_writing.md`，写完后更新 `rules/05_KNOWHOW_INDEX.md`

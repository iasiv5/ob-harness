...
格式参考可以看 `rules/skills/workflow_obmc_env_init.md`（工作流类 skill 的范本）和 `rules/skills/bestpractice_temporal_info_verification.md`（最佳实践类 skill 的范本）。注意这些只是格式参考，核心原则（结果确定性、enabling 而非 SOP）比格式更重要。

...
AI 编程的核心是**结果确定性**：给 AI 打开感知通道（让它看到运行结果）+ 定义清晰的成功标准（什么算"好"），闭合自我迭代反馈环——这是"70% 问题"（AI 能做完 70%、剩 30% 卡住）的根因解。两条最该先知道的：(1) "70% 问题"根因是反馈环断裂——AI 看不到产出是否符合期望、成功标准太主观；(2) 认知外包有界限——形成观点、定义问题和成功标准、关键决策的价值判断必须保留给人，不能外包给 AI。

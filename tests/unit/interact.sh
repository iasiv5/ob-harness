...
# 覆盖 confirm_action / prompt_for_absolute_path / prompt_for_available_port。
# (pick/confirm cancel-warn 覆盖已迁 unit/machine_resolve.sh(cancel 态) + orchestration/build_confirm_cancel.sh; ADR-0019)
